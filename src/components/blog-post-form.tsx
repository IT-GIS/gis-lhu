...
import { BlogCoverImagePicker } from "@/components/blog-cover-image-picker";
          ...
          <div className="mt-5 grid gap-5">
            <label className="block">
              ...
              <span className={helpClass}>
                Judul ini tampil di kartu artikel dan halaman detail Informasi.
              </span>
            </label>
            ...
            <label className="block">
              ...
              />
              <span className={helpClass}>
                Gunakan huruf kecil, angka, dan tanda hubung. Contoh:
                artikel-baru-gislab.
              </span>
            </label>
            ...
            <label className="block">
              ...
              />
              <span className={helpClass}>
                Ringkasan idealnya singkat, jelas, dan menarik untuk pembaca.
              </span>
            </label>
          </div>
        </div>
        ...
        <div className="rounded-[28px] border border-white/70 bg-white/82 p-5 shadow-glass backdrop-blur-2xl dark:border-slate-800 dark:bg-slate-950/58">
          ...
          <div className="mt-5 space-y-4">
            ...
            <label className="block">
              ...
              />
              <span className={helpClass}>
                Boleh dikosongkan. Jika status published, sistem akan memakai
                waktu sekarang.
              </span>
            </label>
          </div>
          ...
          <div className="mt-5 space-y-4">
            <label className="block">
              ...
              <select
                className={fieldClass}
                name="category"
                defaultValue={post?.category ?? blogCategories[0]}
                required
              >
            ...
            <BlogCoverImagePicker defaultValue={post?.coverImage ?? ""} />
          </div>
        </div>

        <div className="rounded-[28px] border border-cyan-100 bg-cyan-50/55 p-5 dark:border-slate-800 dark:bg-slate-900/60">
          <h3 className="text-sm font-bold text-[var(--color-gis-navy)] dark:text-slate-100">
            Tips pengisian
          </h3>
          <ul className="mt-3 space-y-2 text-xs leading-5 text-slate-600 dark:text-slate-300">
            ...
            <li>
              Konten artikel bisa memakai subjudul dan daftar menggunakan baris
              baru.
            </li>
          </ul>
        </div>
